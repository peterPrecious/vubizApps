<%@ Page
  ...
  CodeBehind="IBAOtoNOP.aspx.cs"
  Inherits="vubiz.apps.IBAOtoNOP" %>
...
<head runat="server">
  ...
  <title>Redirect IBAO from V5 to NOP</title>
  <meta charset="utf-8" />
  ...
  <link href='//vubiz.com/vubizApps/styles/skins/ibao.css' rel='stylesheet' />
  <link href='//vubiz.com/vubizApps/styles/skins/ibao.less' type='text/css' rel='stylesheet/less' />
  <script src='//vubiz.com/vubizApps/scripts/less-1.5.1.min.js'></script>

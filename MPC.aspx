    ...
    <div style="margin: 20px;">
      ...
      <asp:Table ID="campusTable" runat="server" Width="500px">
        ...
        <asp:TableRow>
          ...
          <asp:TableCell>
            <asp:TextBox runat="server" ID="membId" Text=""></asp:TextBox>
          </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow>
          ...
          <asp:TableCell>
            <asp:RadioButton ID="langEn" Text="EN" GroupName="radioLang" runat="server" Checked="True" />&nbsp;&nbsp;&nbsp;
            <asp:RadioButton ID="langFr" Text="FR" GroupName="radioLang" runat="server" />
          </asp:TableCell>
        </asp:TableRow>
